...
(cl:defmethod cl:initialize-instance :after ((m <WheelsCmdStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WheelsCmdStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name swarm_controller-msg:<WheelsCmdStamped> is deprecated: use swarm_controller-msg:WheelsCmdStamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <WheelsCmdStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader swarm_controller-msg:header-val is deprecated.  Use swarm_controller-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'vel_left-val :lambda-list '(m))
(cl:defmethod vel_left-val ((m <WheelsCmdStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader swarm_controller-msg:vel_left-val is deprecated.  Use swarm_controller-msg:vel_left instead.")
  (vel_left m))

(cl:ensure-generic-function 'vel_right-val :lambda-list '(m))
(cl:defmethod vel_right-val ((m <WheelsCmdStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader swarm_controller-msg:vel_right-val is deprecated.  Use swarm_controller-msg:vel_right instead.")
  (vel_right m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WheelsCmdStamped>)))
  ...
  "swarm_controller/WheelsCmdStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WheelsCmdStamped)))
  "Returns string type for a message object of type 'WheelsCmdStamped"
  "swarm_controller/WheelsCmdStamped")
